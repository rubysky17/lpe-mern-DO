...
function IYL() {
  ...
  return (
    <div className="iyl container-fluid">
      <div className="row">
        <img
          src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-banner.jpg"
          alt="img"
      ...
      <div>
        <div className="row flex-alignitem">
          <div className="col-md-6">
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-dang-ky-uu-dai.png"
              alt="img"
            />
          </div>
          <div className="col-md-6">
        ...
        <div className="row flex-alignitem pb-3">
          <div className="col-md-6 offset-md-3">
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-dang-ky-uu-dai-2.png"
              alt="img"
              className="mx-auto"
            />
          </div>
          <div className="col-md-8 offset-md-2">
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-giac-mo-vi-dai.png"
              alt="img"
              className="mx-auto"
            />
            <p>
            ...
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-giac-mo-vi-dai-1.png"
              alt="img"
              className="mx-auto"
            />
            <p>
      ...
      <div className="container pageBreak ">
        <div className="row  mt-4 ">
          <div className="col-md-10 offset-md-1">
            <div className="row flex-alignitem">
              <div className="col-md-6">
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-cham-toi-giac-mo.png"
                  alt="img"
                />
                <p>
                  <img
                    src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/mui-ten.png"
                    alt="img"
              ...
              <div className="col-md-6">
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-cham-toi-giac-mo-phai.png"
                  alt="img"
        ...
        <div className="row mt-3 ">
          <div className="col-md-8 offset-md-2">
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-vuot-qua-noi-so-hai.png"
              alt="img"
              className="col-10 offset-1"
            />
            <p>
            ...
            ></iframe>
            <img
              src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thay-doi-tich-cuc.png "
              alt="img"
              className="col-10 offset-1"
            />
          </div>
        ...
        <div className="row flex-alignitem">
          <div className="col-md-10 offset-md-1">
            <div className="row flex-alignitem">
              ...
              <div className="col-md-6">
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-vuot-so-hai-1.jpg"
                  alt="img"
                  // className="col-10 offset-1"
                />
              </div>
        ...
        <div className="row ">
          <img
            src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-xay-dung-cho-doi-tuong.png"
            alt="img"
            className="col-10 offset-1"
          />
          <div className="col-md-10 offset-md-1">
            <div className="row flex-alignitem text-center">
              <div className="col-md-6 mb-3">
                ...
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-doi-tuong-1.png"
                  alt="img"
                />
                <p>
              ...
              <div className="col-md-6 mb-3">
                ...
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-doi-tuong-2.png"
                  alt="img"
                />
                <p>
              ...
              <div className="col-md-6 mb-3">
                ...
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-doi-tuong-3.png"
                  alt="img"
                />
                <p>
              ...
              <div className="col-md-6 mb-3">
                ...
                <img
                  src="https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/offline/iyl/thap-sang-cuoc-doi-ban-iyl-lpe-doi-tuong-4.png"
                  alt="img"
                />
                <p>
                  Muốn vượt qua giới hạn, vượt qua nổi sợ hãi để mạnh mẽ thẳng
