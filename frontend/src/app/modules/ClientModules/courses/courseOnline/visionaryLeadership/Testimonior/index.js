...
function Testimonior() {
  const persons = [
    {
      name: "Anh Thái Tuấn",
      ava: "https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/online/visionary-leadership/ava1.jpg",
      comment:
    ...
    {
      name: "Chị Anh Chi",
      ava: "https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/online/visionary-leadership/ava2.jpg",
      comment:
    ...
    {
      name: "Anh Hữu Phương",
      ava: "https://lpe.vn/img/lpe/chuong-trinh-huan-luyen/online/visionary-leadership/ava3.jpg",
      comment:
